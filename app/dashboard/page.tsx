  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 text-slate-900">
      ...
      <div className="relative overflow-hidden bg-slate-900 p-8 md:p-12 rounded-[40px] shadow-2xl border border-white/5">
        <div className="relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-[1000] text-white tracking-tighter leading-none mb-4 uppercase">
            Dashboard <br />
            <span className="text-amber-400 text-transparent bg-clip-text bg-gradient-to-r from-amber-300 to-blue-500">Desa Terusan Muara</span>
          </h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        {[
          ...
          <div key={i} className={`${item.color} ${item.label === 'Status Sistem' ? 'text-white' : 'text-slate-900'} border border-slate-200 p-8 rounded-[35px] transition-all hover:scale-105 shadow-sm`}>
            ...
            <h3 className={`text-4xl font-[1000] tracking-tighter ${item.label === 'Status Sistem' ? 'text-amber-400' : 'text-slate-900'}`}>
              {loading ? "..." : item.val}
      ...
      <div className="bg-white p-8 md:p-10 rounded-[45px] border border-slate-200 shadow-xl overflow-hidden relative">
        ...
        <div className="relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="border-l-4 border-amber-500 pl-6 py-2 bg-slate-50 rounded-r-2xl">
            ...
            <div className="border-l-4 border-amber-400 pl-6 py-2 bg-slate-50 rounded-r-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pb-10">
        ...
        >
          <div>
            <h3 className="text-2xl font-black text-white italic mb-2 flex items-center gap-2 group-hover:text-amber-400 transition-colors">
              Lihat Website Utama ↗
            </h3>
            <p className="text-slate-400 text-sm font-medium">Cek hasil publikasi konten Desa Terusan Muara secara live.</p>
          </div>
          <div className="mt-8 flex justify-end">
            <div className="h-14 w-14 bg-white/10 rounded-2xl flex items-center justify-center group-hover:bg-amber-400 group-hover:text-slate-900 transition-all text-white text-xl">
              🚀
            </div>
          </div>
        </Link>
        ...
        <div className="bg-white p-8 rounded-[40px] border border-slate-200 shadow-xl flex flex-col justify-between">
          ...
          <button 
            ...
            className="mt-8 w-full py-4 bg-amber-300 text-slate-900 rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-amber-400 transition-all shadow-lg"
          >
            Buka Panduan Cepat 📖
          </button>
        </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full max-w-2xl rounded-[40px] p-8 md:p-12 shadow-2xl max-h-[85vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-3xl font-black text-slate-900 tracking-tighter uppercase">Panduan <span className="text-amber-600">Admin</span></h2>
            ...
            <div className="space-y-4">
              <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100">
                <h4 className="font-black text-slate-900 text-sm uppercase mb-2 flex items-center gap-2">
                   <span className="w-2 h-2 bg-amber-500 rounded-full"></span> 1. Kelola Berita
                </h4>
              ...
              <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100">
                <h4 className="font-black text-slate-900 text-sm uppercase mb-2 flex items-center gap-2">
                   <span className="w-2 h-2 bg-amber-500 rounded-full"></span> 2. Manajemen Slider
                </h4>
              ...
              <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100">
                <h4 className="font-black text-slate-900 text-sm uppercase mb-2 flex items-center gap-2">
                   <span className="w-2 h-2 bg-amber-500 rounded-full"></span> 3. Publikasi Data
                </h4>
            ...
            <button onClick={() => setShowGuide(false)} className="mt-8 w-full py-5 bg-slate-900 text-amber-300 rounded-2xl font-black text-xs uppercase tracking-[0.3em] shadow-2xl active:scale-95 transition-all">Tutup Panduan ✅</button>
          </div>
        </div>
      )}
    </div>

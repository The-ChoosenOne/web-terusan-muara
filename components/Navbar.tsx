      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-30">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex space-x-1 md:space-x-2 overflow-x-auto no-scrollbar">
            ...
            <Link href="/layanan" className="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-slate-700 transition-all duration-300 group">
              <svg className="w-5 h-5 text-cyan-300 group-hover:text-cyan-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <span className="font-semibold text-sm group-hover:text-cyan-300">Layanan</span>
            </Link>
          ...
          {/* === KANAN: Search Bar (Dah Berfungsi Jak!) === */}
          <form 
            onSubmit={handleSearch}
            className="hidden md:flex items-center bg-slate-900/50 rounded-full overflow-hidden border border-slate-600 focus-within:border-cyan-300 transition-all"
          >
            <input 
              type="text" 
              value={searchQuery}
            ...
            />
            <button type="submit" className="bg-cyan-300 hover:bg-cyan-200 text-slate-900 p-2.5 transition-colors duration-300">
